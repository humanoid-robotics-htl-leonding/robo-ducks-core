...
private:
  ...
  /**
   * @brief isIlluminated transforms the pixel into an illumination invariant space to consider
   * between an illuminated spot on the field or something else
   * @param p the point to check
   * @return boolean if spot is illuminated
   */
  bool isIlluminated(const Vector2i& p) const;
  /**
  ...
  /**
   * @brief getOrthogonalPixelProjection returns the point projected onto the line.
   */
